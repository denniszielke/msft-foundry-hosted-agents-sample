"""A2A test client for the trip-scout agent on Azure AI Foundry."""
...
TEST_MESSAGES = [
    ...
    "Find me flights from Munich to Barcelona for June 20th",
    "What hotels are available in Barcelona near the beach?",
]
