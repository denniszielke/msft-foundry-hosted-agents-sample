"""A2A test client for the booking-manager agent on Azure AI Foundry."""
...
TEST_MESSAGES = [
    ...
    "Is there a Lufthansa flight to Barcelona on June 20th?",
    "Book me a flight to Barcelona with Hotel W, checking in June 19 and out June 22"
]
